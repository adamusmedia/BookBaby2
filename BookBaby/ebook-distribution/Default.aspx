...
<div class="container-fluid bg-img bg-ebook-distribution plr-0 pb-20">
    <div class="container plr-0">
        <section class="jumbotron">

			<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 text-left text-center-xs text-center-sm">
				<p class="h1-leadin white">eBOOK DISTRIBUTION</p>
				<h1 class="alt white">Sell your eBook in the world's biggest bookstores.</h1>
				<h2 class="alt white">170 countries, 60+ stores, 1 BookBaby account.</h2>
...
<div class="container-fluid bg-lt-grey">
    <div class="row">
        <section class="container pt-35 text-left">

            <h2 class="title-bold pt-30">Your eBook – on sale around the globe</h2>

            <p>With over 50 new stores added to its eBook retail network, BookBaby introduces your book to more readers worldwide than anyone else. </p>
 
            <p>Every author knows that distribution to the major stores like Amazon, Barnes &amp; Noble and iBooks is important. But only BookBaby gives you added distribution to dozens of additional eBook retailers.</p>

            <ul class="disc-list">
	            <li>Your book will be made available in any territory in which a given bookstore operates </li>
	            <li>You can opt in or out of any of our partner stores</li>
	            <li>You can restrict your distribution by country if you choose</li>
                <li>Your book will be available to any third-party bookstore our partner provides content for</li>
            </ul>

            <p>As BookBaby adds new stores to its retail lineup, every eBook is delivered to the new store – absolutely free of charge. </p>
