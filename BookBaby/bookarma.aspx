...
<div class="container-fluid bg-lt-blue ptb-40">
    <div class="container">
        <section class="jumbotron light text-center">
            <h1 class="title black no-shadow">Market your book globally through shared social networks </h1>
            <h2 class="subtitle black no-shadow">BookBaby authors receive 20% off your first month! Enter code BookBaby at checkout.</h2>
            <img src="images/bookarma-logo.png" width="380" height="75" alt="Smith Publicity" class="img-responsive center-block mt-20">
        </section>
    </div>
</div>
