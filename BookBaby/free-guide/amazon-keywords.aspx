    ...
    <div class="container">
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 text-left text-center-xs text-center-sm">
            ...
            <div class="col-lg-12 col-md-12">
                <h1 class="title no-shadow mt-0"><strong><em>NEW!</em> Unlock Your Amazon Keywords</strong></h1>
                <p class="lead mt-10">Learn the easy way to harness the power of search terms to help readers find – and buy – your eBook.</p>
            </div>
            <div class="col-lg-12 col-md-12 mtb-40 free-guide-img">
                <img src="/images/request-amazon-keywords.png" alt="Unlock Your Amazon Keywords" class="img-responsive center-block mb-10">
            </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            ...
            <div class="responsive-form" id="request-form">
                ...
                <p><strong>Keywords work as a form of a marketing investment. If you take the time to research and set them up — and continue to monitor your results — they will continue to pay dividends in the form of user search-generated exposure without you having to do anything.</strong></p>
             <ul class="disc-list">
                 <li>Learn three main criteria for what constitutes a “good” keyword</li>
                 <li>Learn what keywords your target audience search for on Amazon</li>
                 <li>Learn how to determine the best keywords for your book</li>
             </ul>
