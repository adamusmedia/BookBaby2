<%@ Page Language="VB" AutoEventWireup="false" CodeFile="seven-step-guide-to-authorpreneurship.aspx.vb"  MasterPageFile="../MasterPage.master" Inherits="seven_step_guide_to_authorpreneurship" %>
        ...
        <div id="free-guide" class="text-left">
            ...
            <div class="col-md-6 col-lg-6">
                ...
                <div class="col-lg-12 col-md-12">
                    <h1 class="title no-shadow pt-35">The path to self-publishing success only takes 7 steps</h1>
                </div>
                <div class="col-lg-12 col-md-12 mtb-40 free-guide-img">
                    <img src="/images/free-guides/request-seven-step-guide-to-authorpreneurship.png" alt="The Seven Step Guide to Authorpreneurship" title="The Seven Step Guide to Authorpreneurship" class="img-responsive center-block">
                </div>
