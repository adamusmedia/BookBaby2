...
<div class="container-fluid section-padding-default bg-lt-grey mt-60 pb-20">
    <div class="container">
        ...
        <h1 class="title no-shadow mt-0 mb-30"><strong>Free guides to writing, publishing, blogging, and more!</strong></h1>
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            ...
            <div class="responsive-form" id="request-form">
             ...
             <p class="lead mt-10">Arm yourself with information on how to publish, market, promote, and sell your next book. Our free guides will help everyone from first-time writers to veteran authors.</p>
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 text-left text-center-xs">



            
        	<div class="apb-item col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="col-xs-12 col-sm-2 col-md-3 col-lg-3">
                    <img src="/images/free-guides/free-guide-marketing-amazon.png" width="85" height="108" alt="The Hybrid Author Game Plan" title="The Hybrid Author Game Plan" class="img-responsive center-block mb-10">
                </div> 
                <div class="col-xs-12 col-sm-10 col-md-9 col-lg-9">
				    <p><span class="pb-title">Marketing Your Book On Amazon</span><br>
				Increase your book's status and sales.</p>
                </div>
			</div>
			<div class="article-divider-3 clearfix"></div>

			<div class="apb-item col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="col-xs-12 col-sm-2 col-md-3 col-lg-3">
					<img src="../../Images/request-guides-hybrid-author-game-plan.jpg" width="85" height="108" alt="The Hybrid Author Game Plan" title="The Hybrid Author Game Plan" class="img-responsive center-block mb-10">
				</div>
				<div class="col-xs-12 col-sm-10 col-md-9 col-lg-9">
					<p><span class="pb-title">The Hybrid Author Game Plan</span><br>
					Self-publish your way to your dream of a traditional publishing deal.</p>
				</div>
			</div>
			<div class="article-divider-3 clearfix"></div>
            ...
            <div class="apb-item col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="col-xs-12 col-sm-2 col-md-3 col-lg-3">
					<img src="../../Images/request-guides-twitter.jpg" width="85" height="108" alt="Twitter for Authors in 10 Minutes a Day" title="Twitter for Authors in 10 Minutes a Day" class="img-responsive center-block mb-10">
				</div>
				<div class="col-xs-12 col-sm-10 col-md-9 col-lg-9">
					<p><span class="pb-title">Twitter for Authors in 10 Minutes a Day</span><br>
					Practical tips to promote your book on Twitter in less than 10 minutes a day.</p>
				</div>
			</div>
			<div class="article-divider-3 clearfix"></div>  			
            ...
            <div class="apb-item col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="col-xs-12 col-sm-2 col-md-3 col-lg-3">
					<img src="../../Images/request-guides-makingmoney.jpg" width="85" height="108" alt="Making Money With Your eBook" title="Think like a marketer and sell your book like a pro." class="img-responsive center-block mb-10">
				</div>
				<div class="col-xs-12 col-sm-10 col-md-9 col-lg-9">
					<p><span class="pb-title">Making Money With Your eBook</span><br>
					Think like a marketer and sell your book like a pro.</p>
				</div>
			</div>
			<div class="article-divider-3 clearfix"></div>      
			...
			<div class="apb-item col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="col-xs-12 col-sm-2 col-md-3 col-lg-3">
					<img src="../../Images/request-guides-ebookpub.jpg" width="85" height="108" alt="eBook Publishing: The How-To Guide For Writers" title="Learn the secrets of eBook production, pricing, marketing, and more." class="img-responsive center-block mb-10">
				</div>
				<div class="col-xs-12 col-sm-10 col-md-9 col-lg-9">
				<p><span class="pb-title">eBook Publishing:<br>
				The How-To Guide For Writers</span><br>
				Learn the secrets of eBook production, pricing, marketing, and more.</p>
			</div>
			<div class="article-divider-3 clearfix"></div>
            
            <div class="apb-item col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="col-xs-12 col-sm-2 col-md-3 col-lg-3">
					<img src="../../images/free-guides/free-guide-amazon-keywords.png" width="85" height="108" alt="eBook Publishing: The How-To Guide For Writers" title="Learn the secrets of eBook production, pricing, marketing, and more." class="img-responsive center-block mb-10">
				</div>
				<div class="col-xs-12 col-sm-10 col-md-9 col-lg-9">
					<p><span class="pb-title">Unlock Your Amazon Keywords</span><br>
					Harness the power of search terms to help readers find – and buy – your eBook.</p>
				</div>
			</div>
			<div class="article-divider-3 clearfix"></div>       
			...
			<div class="apb-item col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="col-xs-12 col-sm-2 col-md-3 col-lg-3">
					<img src="../../Images/request-guides-blogging101.jpg" width="85" height="108" alt="Blogging 101" title="All the products and services you need to publish your book." class="img-responsive center-block mb-10">
				</div>
				<div class="col-xs-12 col-sm-10 col-md-9 col-lg-9"> 
	     			<p><span class="pb-title">Blogging 101</span><br>
					How to use your blog to reach new readers and connect with existing fans.</p>
				</div>
			</div>
			<div class="article-divider-3 clearfix"></div>        
			...
			<div class="apb-item col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="col-xs-12 col-sm-2 col-md-3 col-lg-3">
	      			<img src="/Images/request-guides-5secrets.jpg" width="85" height="108" alt="BookBaby Catalog" title="All the products and services you need to publish your book." class="img-responsive center-block mb-10">
      			</div>
      			<div class="col-xs-12 col-sm-10 col-md-9 col-lg-9">
					<p><span class="pb-title">5 Secrets of Successful Authors</span><br>
					The first in an ongoing series of inside secrets from indie authors who have made it big!</p>
				</div>
			</div>
			<div class="article-divider-3 clearfix"></div>      
			...
			<div class="apb-item col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="col-xs-12 col-sm-2 col-md-3 col-lg-3">
	      			<img src="/Images/request-guides-business-ebooks.jpg" width="85" height="108" alt="Grow your business with eBooks" title="How companies large and small are joining the eBook revolution." class="img-responsive center-block mb-10">
      			</div>
      			<div class="col-xs-12 col-sm-10 col-md-9 col-lg-9">
					<p><span class="pb-title">How to Grow Your Business<br> with eBooks</span><br>
					Building your brand, prospect list, and customer base with eBooks</p>
				</div>
			</div>
			<div class="article-divider-3 clearfix"></div> 
            
            <div class="apb-item col-xs-12 col-sm-12 col-md-12 col-lg-12 mb-30">
                <div class="col-xs-12 col-sm-2 col-md-3 col-lg-3">
	      			<img src="/Images/request-guide-printed-design-101.jpg" width="85" height="108" alt="Grow your business with eBooks" title="How companies large and small are joining the eBook revolution." class="img-responsive center-block mb-10">
      			</div>
      			<div class="col-xs-12 col-sm-10 col-md-9 col-lg-9">
					<p><span class="pb-title">Printed Book Design 101</span><br>
					How to turn your manuscript into a retail-ready printed book</p>
				</div>
			</div> 
