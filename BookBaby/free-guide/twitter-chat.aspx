    ...
    <div class="container">
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 text-left text-center-xs text-center-sm">
            ...
            <div class="col-lg-12 col-md-12">
                <h1 class="title no-shadow mt-0"><strong>Live Chat with BookBaby Authors</strong></h1>
                <p class="lead">Join us monthly for our live Twitter chats by using #BBchat</p>
            </div>
            <div class="col-lg-12 col-md-12 mtb-40 free-guide-img">
                <img src="/images/twitter-chat-logo.png" width="460" height="170" alt="#BBchat" class="img-responsive center-block mb-10">
            </div>
            <p>Once each month, typically on the second or third Wednesday, we host our own #BBchat Twitter chat. Our past topics range from marketing strategies to trends in book e-retail and beyond. A transcript of the chat will be posted afterwards. If you have any topic ideas you would like to see us cover in the future, please let us know. We look forward to hosting more of these events in the future and welcome your ongoing participation!</p>
            <p><a href="http://blog.bookbaby.com/?s=%23bbchat">View all our past #BBChat topics</a></p>
...
<div class="container-fluid bg-img bg-twitter-chat ptb-60">
    <div class="container">
    </div>
</div>
...
<div class="container text-left ptb-40">
    <h3 class="title-bold">To participate, simply tweet during the scheduled time using the #BBchat hashtag!</h3>
    

    <p><strong>Basic guidelines:</strong></p>

    <ol class="num-list">
        <li>Log in to Twitter a few minutes prior to the chat and enter #BBchat in the search box. (TweetChat and TweetDeck are great Twitter tools to use when following the chat!)</li>
        <li>Follow @bookbaby from the Twitter account you plan to use for #BBchat.</li>
        <li>Introduce yourself, stay on topic, and feel free to retweet (RT)!</li>
        <li>Make sure you use the #BBchat hashtag in any of the tweets you are posting to the chat, otherwise they might be missed!</li>
        <li>Have fun!</li>
    </ol>
