    ...
    <div class="container">
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 text-left text-center-xs text-center-sm">
            ...
            <div class="col-lg-12 col-md-12">
                <h1 class="title no-shadow mt-0"><strong>Making Money With Your eBook</strong></h1>
                <p class="lead mt-10">Think like a marketer and sell your book like a pro.</p>
            </div>
            <div class="col-lg-12 col-md-12 mtb-40 free-guide-img">
                <img src="/images/request-marketing.png" class="img-responsive center-block mb-10">
            </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            ...
            <div class="responsive-form" id="request-form">
                ...
                <p>Written by a marketer for would-be book marketers, BookBaby’s latest guide shows how authors can utilize simple strategies and tools used to sell millions of products each day:</p>
             <ul class="disc-list">
                 <li>Learn how to identify your potential readers – before you even type your first word.</li>
                 <li>Establish your book’s selling position with some basic – yet powerful – marketing tools.</li>
                 <li>Here, there and everywhere – a plan to let others sell your book in 1000s of places on the web.</li>
             </ul>
