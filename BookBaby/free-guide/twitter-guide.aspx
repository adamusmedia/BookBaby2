    ...
    <div class="container">
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 text-left text-center-xs text-center-sm">
            ...
            <div class="col-lg-12 col-md-12">
                <h1 class="title no-shadow mt-0"><strong>Promoting your book on Twitter: a sane strategy for busy writers.</strong></h1>
            </div>
            <div class="col-lg-12 col-md-12 mtb-40 free-guide-img">
                <img src="/images/request-twitter-guide.png" alt="Promoting your book on Twitter" title="Promoting your book on Twitter" width="420" height="510" class="img-responsive center-block mb-10">
            </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            ...
            <div class="responsive-form" id="request-form">
             ...
             <p><strong>Practical tips to promote your book on Twitter in less than 10 minutes a day.</strong></p>
                <p>Your writing time is worth protecting. As an author, you don’t want to get sucked into yet another social media black hole. That’s why BookBaby has put together “Twitter for Authors in 10 Minutes a Day,” a free guide that will help you use Twitter to connect with readers, book reviewers, fellow writers, and your literary heroes all over the world — without spending your entire life online.</p>
                <p>Inside you will learn about:</p>
             <ul class="disc-list">
                 <li>Why Twitter is better than Facebook</li>
                 <li>How to compose effective tweets</li>
                 <li>Scheduling tweets in advance</li>
                 <li>Using Bit.ly and Google Analytics to track interactions</li>
                 <li>Monitoring Twitter conversations about your books with HootSuite and TweetDeck</li>
                 <li>And much more!</li>
             </ul>
