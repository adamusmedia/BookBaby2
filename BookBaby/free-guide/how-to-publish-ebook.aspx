    ...
    <div class="container">
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 text-left text-center-xs text-center-sm">
            ...
            <div class="col-lg-12 col-md-12">
                <h1 class="title no-shadow mt-0"><strong>eBook Publishing Guide</strong></h1>
                <p class="lead mb-10">The How-To Guide for Writers</p>
                <p>Learn how to make, price, promote and sell your eBook.</p>
            </div>
            <div class="col-lg-12 col-md-12 mtb-40 free-guide-img">
                <img src="/images/request-howto.png" alt="eBook Publishing: The How-To Guide For Writers" class="img-responsive center-block mb-10">
            </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            ...
            <div class="responsive-form" id="request-form">
             ...
             <p><strong>Whether you’re a rookie or an experienced pro in the eBook world BookBaby’s newest guide has something for everyone, including:</strong></p>
             <ul class="disc-list">
                 <li>Proven eBook pricing strategies and tactics</li>
                 <li>Why authors can’t skimp on editing or cover design.</li>
                 <li>How metadata is vital to your online sales success.</li>
             </ul>
