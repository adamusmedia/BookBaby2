    ...
    <div class="container">
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 text-left text-center-xs text-center-sm">
            ...
            <div class="col-lg-12 col-md-12">
                <h1 class="title no-shadow mt-0"><strong>How to take your manuscript to marketplace in 6 weeks</strong></h1>
                <p class="lead mt-10"><em>Free 105-page eBook!</em></p>
            </div>
            <div class="col-lg-12 col-md-12 mtb-40 free-guide-img">
                <img src="/images/request-the-end.png" alt="The End, Now What?!" title="The End, Now What?!" width="420" height="449" class="img-responsive center-block mb-10">
            </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            ...
            <div class="responsive-form" id="request-form">
             ...
             <p><strong>Completing your book was a big achievement, but your work is far from over.</strong></p>
                <p>BookBaby President Steven Spatz outlines a simple 6-week strategy to help you create a book that will catch readers’ attention, get reviewers talking, and take you to the next level in your writing career.</p>
                <p>This free eBook covers:</p>
             <ul class="disc-list">
                 <li>Manuscript tips from a bestselling author</li>
                 <li>How to find an editor on any budget – even $0</li>
                 <li>Choosing a publishing pathway that’s best for you</li>
