    ...
    <div class="container">
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 text-left text-center-xs text-center-sm">
            ...
            <div class="col-lg-12 col-md-12">
                <h1 class="title no-shadow mt-0"><strong>5 Secrets of Successful Authors</strong></h1>
                <p class="lead mt-10">A Guide for Self-publishing: PART ONE</p>
            </div>
            <div class="col-lg-12 col-md-12 mtb-40 free-guide-img">
                <img src="/images/request-5secrets.png" class="img-responsive center-block mb-10">
            </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            ...
            <div class="responsive-form" id="request-form">
                ...
                <p><strong>First in an ongoing series of inside secrets from indie authors who have made it big!</strong></p>
                <p>Learn about how CJ Lyons went from a Pediatric ER doctor to a New York Times best-selling author:</p>
             <ul class="disc-list">
                 <li>Learn the ONLY two rules she follows when writing</li>
                 <li>Understand how “Emotional Velcro” can capture your readers</li>
                 <li>How being honest and truthful with yourself is the key topromoting your book</li>
                 <li>...and much more</li>
             </ul>
