    ...
    <div class="container">
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 text-left text-center-xs text-center-sm">
            ...
            <div class="col-lg-12 col-md-12">
                <h1 class="title no-shadow mt-0"><strong>Blogging 101</strong></h1>
                <p class="lead">A guide to promoting your writing in the blogosphere.</p>
            </div>
            <div class="col-lg-12 col-md-12 mtb-40 free-guide-img">
                <img src="/Images/request-blogging101.png" alt="Blogging 101 - A guide to promoting your writing in the blogsphere." class="img-responsive center-block mb-10">
            </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            ...
            <div class="responsive-form" id="request-form">
             ...
             <p><strong>We’ve partnered with marketing guru Bob Baker of FullTimeAuthor.com to offer you a free excerpt from his book,</strong> <em>55 Ways to Promote & Sell Your Book on the Internet.</em></p>
             <p>From publishing your first post to promoting your latest book, learn how to use your blog to reach new readers and connect with existing fans.</p>
