    ...
    <div class="container">
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 text-left text-center-xs text-center-sm">
            ...
            <div class="col-lg-12 col-md-12">
                <h1 class="title no-shadow mt-0"><strong>Printed Book Design 101</strong></h1>
                <p class="lead mt-10">How to turn your manuscript into a retail-ready printed book</p>
            </div>
            <div class="col-lg-12 col-md-12 mtb-40 free-guide-img">
                <img src="/images/request-printed-book-design.png" class="img-responsive center-block mb-10">
            </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            ...
            <div class="responsive-form" id="request-form">
                ...
                <p>Let self-publishing guru Joel Friedlander help you prepare your next printed book.</p>
                <p>BookBaby asked self-publishing expert Joel Friedlander to write the definitive guide to producing a great printed book. The result is our new guide: <strong>Printed Book Design 101.</strong> Friedlander provides step-by-step advice and tips to help you create a retail-ready book. Friedlander covers topics such as:</p>
             <ul class="disc-list">
                 <li>Picking the perfect typeface</li>
                 <li>Enhancing the readability of your book with interior design</li>
                 <li>Catching the reader’s eye with cover design tips from the pros</li>
                 <li>The most common mistakes made by self-publishing authors and how you can avoid them</li>
                 <li>...and much more</li>
             </ul>
