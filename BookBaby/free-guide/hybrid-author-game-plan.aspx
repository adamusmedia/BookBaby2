    ...
    <div class="container">
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 text-left text-center-xs text-center-sm">
            ...
            <div class="col-lg-12 col-md-12">
                <h1 class="title no-shadow mt-0"><strong><em>NEW!</em> The Hybrid Author Game Plan</strong></h1>
                <p class="lead mt-10">Self-publish your way to your dream of a traditional publishing deal</p>
            </div>
            <div class="col-lg-12 col-md-12 mtb-40 free-guide-img">
                <img src="/images/request-hybrid-author-game-plan.png" alt="The Hybrid Author Game Plan" class="img-responsive center-block mb-10">
            </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            ...
            <div class="responsive-form" id="request-form">
             ...
             <p><strong>Learn how to get the best of both publishing worlds. You don’t have to choose between self-publishing and pursuing a traditional book deal. This free guide shows you how to do both. In it you’ll learn:</strong></p>
             <ul class="disc-list">
                 <li>What hybrid publishing is</li>
                 <li>The benefits for you and for publishers</li>
                 <li>Which kind of hybrid publishing is right for you</li>
             </ul>
