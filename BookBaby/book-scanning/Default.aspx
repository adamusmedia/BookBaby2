    ...
    <div class="container">
        <div class="row">
            <section class="jumbotron light">
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-7 text-left-md text-left-lg text-center-mobile">
    ...
    <div class="container">
        <div id="book-scanning" class="row text-left">
            ...
            <div class="col-xs-12 col-sm-7 col-md-7 col-lg-8 mb-20">
                ...
                <h2 class="title-bold">Bound Book Scanning</h2>
                ...
                <h2 class="title-bold">Fast and Affordable</h2>
