...
(function($) {
  ...
  $.fn.coversCarousel = function (options) {

    // override the default options with user defined options
    options = $.extend({}, $.fn.coversCarousel.defaults, options || {});
  ...
  $.fn.coversCarousel.defaults = {
    ...
    pauseOnHover:       true,    // accepts 'blips' to generate and display numbered blips indicating what feature is centered
